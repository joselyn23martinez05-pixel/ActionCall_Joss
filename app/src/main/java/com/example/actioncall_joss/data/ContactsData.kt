package com.example.actioncall_joss.data
...
val listaContactos = listOf(
    ...
    Contacto("Laura Hernández", "4775678901", 0),
    Contacto("Pedro Sánchez", "4776789012", 0),
    Contacto("Sofía Martínez", "4777890123", 0),
    Contacto("Diego Torres", "4778901234", 0)
)
